...
.method private static a(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    const-string v3, "Error reading device context"
...
.method private static a(Landroid/content/Context;Lcom/a/a/e;)Lorg/json/JSONObject;
    ...
    const-string v3, "Failed to build device contexts"
...
.method private static a(Lcom/a/a/e;)Lorg/json/JSONObject;
    ...
    const-string v3, "Error reading package context"
...
.method public static a()V
    ...
    const-string v2, " cached response(s)"
...
.method public static a(Lcom/a/a/m;)V
    ...
    const-string v1, "SentryEventBuilder in captureEvent is null"
...
.method private static c(Landroid/net/Uri;)Ljava/lang/String;
    ...
    const-string v4, "sentry_version=%s,"
    ...
    const-string v4, "sentry_client=sentry-android/%s,"
    ...
    const-string v3, "sentry_secret=%s"
...
.method private static e(Ljava/lang/String;)Ljava/util/List;
    ...
    :try_end_b
    .catch Ljava/net/URISyntaxException; {:try_start_1 .. :try_end_b} :catch_d
...
.method private static h()Lorg/json/JSONObject;
    ...
    const-string v3, "Error reading OS context"

...
.method private c(Lco/ronash/pushe/k/l;)V
    ...
    const-string v0, "InstanceId is null, resetting token state to 0."
...
.method public a(Lco/ronash/pushe/h/b/o;)V
    ...
    .catch Lco/ronash/pushe/k/o; {:try_start_0 .. :try_end_3} :catch_47
    ...
    const-string v2, "Sending Upstream Message failed in UpstreamSender.sendMessage() - "
...
.method public a(Lco/ronash/pushe/k/l;)V
    ...
    .catch Lco/ronash/pushe/k/o; {:try_start_6 .. :try_end_9} :catch_54
    ...
    const-string v3, "Sending Upstream Message failed in UpstreamSender.sendMessage() - "
    ...
    const-string v5, "Refactored Upstream Message"
...
.method public b(Lco/ronash/pushe/h/b/o;)V
    ...
    const-string v1, "$stats_send_attempts"
    ...
    const-string v2, "Sending Upstream Message"
    ...
    const-string v4, "gcm.googleapis.com"
    ...
    const-string v1, "Sent Upstream Message stored in DB"
    ...
    const-string v1, "$stats_sent_messages"
...
.method public b(Lco/ronash/pushe/k/l;)V
    ...
    const-string v0, "Sent Upstream Message stored in DB"

...
.method public run()V
    ...
    const-string v8, "DELETE FROM enc_tasks_v2 WHERE mid IN(%s)"
    ...
    const-string v7, "SELECT mid, date FROM enc_tasks_v2 WHERE date = (SELECT min(date) FROM enc_tasks_v2)"
    ...
    :try_end_6a
    .catch Ljava/lang/Exception; {:try_start_60 .. :try_end_6a} :catch_5b

...
.method public run()V
    ...
    const-string v11, "SELECT uid FROM requested_holes WHERE uid = %d AND ((seq_out_start >= %d AND %d <= seq_out_end) OR (seq_out_start >= %d AND %d <= seq_out_end))"
    ...
    const-string v11, "SELECT m.data, r.random_id, s.seq_in, s.seq_out, m.ttl, s.mid FROM messages_seq as s LEFT JOIN randoms as r ON r.mid = s.mid LEFT JOIN messages as m ON m.mid = s.mid WHERE m.uid = %d AND m.out = 1 AND s.seq_out >= %d AND s.seq_out <= %d ORDER BY seq_out ASC"
    ...
    :try_end_141
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_141} :catch_142
    ...
    const-string v11, "REPLACE INTO requested_holes VALUES(%d, %d, %d)"
    ...
    :try_end_217
    .catch Ljava/lang/Exception; {:try_start_148 .. :try_end_217} :catch_142

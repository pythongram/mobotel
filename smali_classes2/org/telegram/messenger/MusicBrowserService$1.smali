...
.method public run()V
    ...
    const-string v24, "SELECT DISTINCT uid FROM media_v2 WHERE uid != 0 AND mid > 0 AND type = %d"
    ...
    const-string v24, "SELECT uid, data, mid FROM media_v2 WHERE uid IN (%s) AND mid > 0 AND type = %d ORDER BY date DESC, mid DESC"
    ...
    :try_end_296
    .catch Ljava/lang/Exception; {:try_start_7e .. :try_end_296} :catch_68

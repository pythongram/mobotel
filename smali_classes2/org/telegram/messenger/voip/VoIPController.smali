...
.method private getLogFilePath()Ljava/lang/String;
    ...
    const-string v4, "logs/%02d_%02d_%04d_%02d_%02d_%02d_voip.txt"
...
.method public getStats(Lorg/telegram/messenger/voip/VoIPController$Stats;)V
    ...
    const-string v1, "You\'re not supposed to pass null here"
...
.method public setConfig(DDI)V
    ...
    invoke-static {}, Landroid/media/audiofx/AcousticEchoCanceler;->isAvailable()Z
    :try_end_12
    .catch Ljava/lang/Throwable; {:try_start_b .. :try_end_12} :catch_4a
    ...
    const-string v1, "use_system_aec"
...
.method public setEncryptionKey([BZ)V
    ...
    const-string v2, "key length must be exactly 256 bytes but is "
...
.method public setRemoteEndpoints([Lorg/telegram/tgnet/TLRPC$TL_phoneConnection;Z)V
    ...
    const-string v3, "endpoints size is 0"
    ...
    const-string v4, " has empty/null ipv4"
    ...
    const-string v4, " has peer_tag of wrong length"

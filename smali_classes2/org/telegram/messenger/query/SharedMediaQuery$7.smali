...
.method public run()V
    ...
    const-string v5, "SELECT start FROM media_holes_v2 WHERE uid = %d AND type = %d AND start IN (0, 1)"
    ...
    const-string v5, "SELECT end FROM media_holes_v2 WHERE uid = %d AND type = %d AND end <= %d ORDER BY end DESC LIMIT 1"
    ...
    const-string v5, "SELECT data, mid FROM media_v2 WHERE uid = %d AND mid > 0 AND mid < %d AND mid >= %d AND type = %d ORDER BY date DESC, mid DESC LIMIT %d"
    ...
    :try_end_194
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_194} :catch_195
    .catchall {:try_start_6 .. :try_end_194} :catchall_242
    ...
    :try_end_1a8
    .catchall {:try_start_196 .. :try_end_1a8} :catchall_242
    ...
    const-string v5, "SELECT min(mid) FROM media_v2 WHERE uid = %d AND type = %d AND mid > 0"
    ...
    .line 324
    const-string v4, "REPLACE INTO media_holes_v2 VALUES(?, ?, ?, ?)"
    ...
    invoke-virtual/range {v16 .. v16}, Lorg/telegram/SQLite/SQLiteCursor;->dispose()V
    :try_end_240
    .catch Ljava/lang/Exception; {:try_start_1cd .. :try_end_240} :catch_195
    .catchall {:try_start_1cd .. :try_end_240} :catchall_242
    ...
    const-string v5, "SELECT data, mid FROM media_v2 WHERE uid = %d AND mid > 0 AND mid < %d AND type = %d ORDER BY date DESC, mid DESC LIMIT %d"
    ...
    const-string v5, "SELECT max(end) FROM media_holes_v2 WHERE uid = %d AND type = %d"
    ...
    const-string v5, "SELECT data, mid FROM media_v2 WHERE uid = %d AND mid >= %d AND type = %d ORDER BY date DESC, mid DESC LIMIT %d,%d"
    ...
    const-string v5, "SELECT data, mid FROM media_v2 WHERE uid = %d AND mid > 0 AND type = %d ORDER BY date DESC, mid DESC LIMIT %d,%d"
    ...
    const-string v5, "SELECT m.data, m.mid, r.random_id FROM media_v2 as m LEFT JOIN randoms as r ON r.mid = m.mid WHERE m.uid = %d AND m.mid > %d AND type = %d ORDER BY m.mid ASC LIMIT %d"
    ...
    const-string v5, "SELECT m.data, m.mid, r.random_id FROM media_v2 as m LEFT JOIN randoms as r ON r.mid = m.mid WHERE m.uid = %d AND type = %d ORDER BY m.mid ASC LIMIT %d,%d"
    ...
    :try_end_45a
    .catch Ljava/lang/Exception; {:try_start_266 .. :try_end_45a} :catch_195
    .catchall {:try_start_266 .. :try_end_45a} :catchall_242

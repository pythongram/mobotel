...
.method public run()V
    ...
    const-string v12, "SELECT MAX(mid), MAX(date) FROM messages WHERE uid = %d AND out = 1"
    ...
    const-string v12, "SELECT date FROM messages WHERE uid = %d AND mid < %d AND out = 1 ORDER BY date DESC"
    ...
    invoke-virtual {v2}, Lorg/telegram/SQLite/SQLiteCursor;->dispose()V
    :try_end_7f
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_7f} :catch_8b
